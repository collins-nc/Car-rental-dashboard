          ...
          <div className="offer__list">
            <div className="offer__item">
              <div className="box__01">
                ...
                <h6 className="avg__price">
                  R16,605 <span>average price</span>
                </h6>

                <h6 className="market__price">Market average is R16,244</h6>
              ...
              <div className="box__03">
                ...
                <h6 className="spend__amount">R1174</h6>
              ...
              <div className="box__05">
                ...
                <h6 className="spend__amount">R811</h6>
            ...
            <div className="offer__item">
              <div className="box__01">
                ...
                <h6 className="avg__price">
                  R11,605 <span>average price</span>
                </h6>

                <h6 className="market__price">Market average is R11,244</h6>
                <span className="arrow__key">
                  <i class="ri-arrow-right-line"></i>
                </span>
              </div>
